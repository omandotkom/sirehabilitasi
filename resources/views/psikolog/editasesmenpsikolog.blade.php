...
<div class="main-container">
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-100px">
            ...
            @php
            function in_array_2($var1,$var2) {
            if (!is_null($var2) && in_array($var1,$var2)){
            return true;
            }
            return false;
            }
            ...
            <div id="printArea" class="pd-20 card-box mb-30">
                ...
                <form action="{{route('saveasesmenpsikolog',$ps->id)}}" method="post">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @endphp
                                        <input type="checkbox" @if(in_array_2('ya',$c_pencurian))checked @endif name="c_pencurian[]" value="ya"> <br />
                                    </td>
                                    <td>
                                        <input type="checkbox" @if(in_array_2('tidak',$c_pencurian))checked @endif name="c_pencurian[]" value="tidak"> <br />
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="checkbox" @if(in_array_2('ya',$c_perampokan))checked @endif name="c_perampokan[]" value="ya"> <br />
                                    </td>
                                    <td>
                                        <input type="checkbox" @if(in_array_2('tidak',$c_perampokan))checked @endif name="c_perampokan[]" value="tidak"> <br />
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>Tawuran</td>
                                    <td>
                                        <input type="checkbox" @if(in_array_2('ya',$c_tawuran))checked @endif name="c_tawuran[]" value="ya"> <br />
                                    </td>
                                    <td>
                                        <input type="checkbox" @if(in_array_2('tidak',$c_tawuran))checked @endif name="c_tawuran[]" value="tidak"> <br />
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input @if(in_array_2('ya',$c_seksbebas))checked @endif type="checkbox" name="c_seksbebas[]" value="ya"> <br />
                                    </td>
                                    <td>
                                        <input @if(in_array_2('tidak',$c_seksbebas))checked @endif type="checkbox" name="c_seksbebas[]" value="tidak"> <br />
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input @if(in_array_2('ya',$c_napza))checked @endif type="checkbox" name="c_napza[]" value="ya"> <br />
                                    </td>
                                    <td>
                                        <input type="checkbox" @if(in_array_2('tidak',$c_napza))checked @endif name="c_napza[]" value="tidak"> <br />
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="checkbox" @if(in_array_2('ya',$c_miras))checked @endif name="c_alkohol[]" value="ya"> <br />
                                    </td>
                                    <td>
                                        <input type="checkbox" @if(in_array_2('tidak',$c_miras))checked @endif name="c_alkohol[]" value="tidak"> <br />
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="checkbox" @if(in_array_2('ya',$c_menjualnapza))checked @endif name="c_menjualnapza[]" value="ya"> <br />
                                    </td>
                                    <td>
                                        <input type="checkbox" @if(in_array_2('tidak',$c_menjualnapza))checked @endif name="c_menjualnapza[]" value="tidak"> <br />
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input @if(in_array_2('ya',$c_penjara))checked @endif type="checkbox" name="c_penjara[]" value="ya"> <br />
                                    </td>
                                    <td>
                                        <input type="checkbox" @if(in_array_2('tidak',$c_penjara))checked @endif name="c_penjara[]" value="tidak"> <br />
                                    </td>
                                    <td>
                    ...
                    <div class="btn-list">
                        <input id="printButton" class="btn btn-primary" type="button" onclick="printDiv('printArea');" value="Cetak">
                    </div>
            </div>
        </div>
