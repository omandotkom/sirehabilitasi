			...
			<div id="printable" class="pd-20 card-box mb-30">
				...
				<form action="{{route('savepemerlupelayanan',$pemerlu->id)}}" method="POST">
					...
					<div class="form-group row">
						...
						<div class="col-sm-12 col-md-10">
							<input class="form-control" name="nama" value="{{$pemerlu->nama}}" type="text" placeholder="1">
						</div>
					</div>
					<div class="form-group row">
					...
					<div class="form-group row">
						...
						<div class="col-sm-12 col-md-10">
							<input name="namaayah" class="form-control" type="text" value="{{$pemerlu->namaayah}}" placeholder="1">
						</div>
					</div>
					<div class="form-group row">
						<label class="col-sm-12 col-md-2 col-form-label">NIK</label>
