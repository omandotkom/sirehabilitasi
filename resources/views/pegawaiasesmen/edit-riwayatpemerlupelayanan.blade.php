					...
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Riwayat Pemerlu Pelayanan</h4>
											...
											<div class="pd-20 card-box mb-30">
												...
												<div class="form-group row">
													...
													<div class="col-sm-12 col-md-10">
														<input class="form-control" placeholder="SD" type="text">
													</div>
												</div>
												<div class="form-group row">
							...
							<div class="form-group row">		
										...
										<div class="col-sm-12 col-md-10">
											<input class="form-control" placeholder="SMA" type="sma">
										</div>
							</div>	
							<div class="form-group row">		
								<label class="col-sm-12 col-md-2 col-form-label">Kuliah</label>
								<div class="col-sm-12 col-md-10">
									<input class="form-control" placeholder="Kuliah" type="kuliah">
								</div>
							</div>	
							<div class="form-group row">		
								<label class="col-sm-12 col-md-2 col-form-label">Pendidikan Non Formal</label>
								<div class="col-sm-12 col-md-10">
									<input class="form-control" placeholder="Kursus/Organisasi/Prestasi" type="text">
								</div>
							</div>
