	...
	<div class="pd-ltr-20 xs-pd-20-10">
		<div class="min-height-100px">
			...
			<div class="pd-20 card-box mb-30">
				...
				<form action="{{route('savebuatakunpegawai')}}" method="post">
					@csrf
					<div class="form-group row">
						<label class="col-sm-12 col-md-2 col-form-label">Nama</label>
						<div class="col-sm-12 col-md-10">
							<input class="form-control" name="nama" type="text" placeholder="1">
						</div>
					</div>
					<div class="form-group row">
						<label class="col-sm-12 col-md-2 col-form-label">NIP</label>
						<div class="col-sm-12 col-md-10">
							<input class="form-control" name="nip" placeholder="" type="">
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-12 col-md-10">
							<select name="role" class="custom-select col-12">
								...
								<option value="asesmen">Pegawai Asesmen</option>
