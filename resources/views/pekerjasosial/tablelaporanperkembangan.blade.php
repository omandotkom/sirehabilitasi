		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-100px">
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Data Laporan Perkembangan</li>
								</ol>
							</nav>
						</div>
				...
				<div class="card-box mb-30">
					<div class="pd-20">
						<h4 class="text-blue h4">Data Laporan Perkembangan</h4>
						...
						<table class="data-table table stripe hover nowrap">
							<thead>
								<tr>
									...
									<th class="table-plus datatable-nosort">Laporan Perkembangan Bulan Ke</th>
