			...
			<div id="printArea" class="pd-20 card-box mb-30">
				...
				<form action="{{route('savelaporanperkembangan',$laporan->id)}}" method="post">
					...
					<div class="form-group row">
						...
						<div class="col-sm-12 col-md-10">
							<input name="pemerlulayanan_id" value="{{$laporan->pemerlulayanan_id}}" class="form-control" type="text" placeholder="1">
						</div>
					</div>
					<div class="form-group row">
						<label class="col-sm-12 col-md-2 col-form-label">Nama</label>
						<div class="col-sm-12 col-md-10">
							<input class="form-control" value="{{$laporan->nama}}" name="nama" type="text" >
						</div>
					</div>
					<div class="form-group row">
